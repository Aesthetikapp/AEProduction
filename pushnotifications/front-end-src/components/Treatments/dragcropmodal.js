		...
		<>
			...
			<div className="row">
				...
				>
					<>
						{!croppedImage && (
							<label
								...
								className={
									props.border1.red8 === "" ? "imageborder" : props.border1.red8
								}
							>
								<input
									ref={fileInput}
					...
					>
						<label className="f-fm fm-w5-s12 color-AC">Cover&nbsp;Photo</label>
					</label>
					<div>
						<Modal
							style={{}}
							...
							{croppedImage2 && (
								<label
									style={{
										...
										backgroundColor: "#ffffff",
										backgroundImage:
											"url(" + window.URL.createObjectURL(croppedImage2) + ")",
										backgroundRepeat: "no-repeat",
										backgroundPosition: "center",
										backgroundSize: "cover",
										cursor: "pointer",
									...
									draggable="true"
									onDragStart={() => {
										dragStart2(croppedImage2);
									}}
									onDragOver={(event) => event.preventDefault()}
									onDrop={() => {
										dragWord2(croppedImage2);
									}}
								></label>
							)}
						</>
										...
										<div className="col">
											<div>
												{imageToCrop2 ? (
													...
													<>{ConvertToImageFormat2(getUpload2, "")}</>
												)}
											</div>
										</div>
									</div>
